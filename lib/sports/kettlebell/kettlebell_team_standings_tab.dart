...
import 'kettlebell_scoring.dart' as scoring;

class KettlebellTeamStandingsTab extends ConsumerStatefulWidget {
  final int tId;
  const KettlebellTeamStandingsTab({super.key, required this.tId});

  @override
  ConsumerState<KettlebellTeamStandingsTab> createState() => _KettlebellTeamStandingsTabState();
}

class _KettlebellTeamStandingsTabState extends ConsumerState<KettlebellTeamStandingsTab> {
  bool _loading = true;
  List<scoring.KettlebellStanding> _standings = [];
