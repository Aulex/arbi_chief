/// Powerlifting scoring logic.
///
/// Rules: 1st place = 1pt, 2nd = 2pts, etc. Lower total sum wins.
/// Team scoring: 3 best results from 3 different weight categories.
/// Missing categories penalised with (largest category size + 1).
/// Tie-breakers: Most 1st places, then most 2nd places, then lower total body weight.
...
List<PowerliftingStanding> calculateStandings({
  ...
  for (final team in teams) {
    standings[team.teamId] = PowerliftingStanding(
      teamId: team.teamId,
