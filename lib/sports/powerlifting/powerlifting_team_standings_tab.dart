...
class PowerliftingTeamStandingsTab extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PowerliftingTeamStandingsTab> createState() => _PowerliftingTeamStandingsTabState();
}

class _PowerliftingTeamStandingsTabState extends ConsumerState<PowerliftingTeamStandingsTab> {
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    ...
    final placesMap = await plSvc.getPlayerPlaces(widget.tId);
    final categoriesMap = await plSvc.getPlayerCategories(widget.tId);
    final weightsMap = await plSvc.getPlayerWeights(widget.tId);
